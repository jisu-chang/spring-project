...
- 퀴즈 기능 개발: 풀지 않은 퀴즈 출제, 정답 여부 판단, 풀이 시간 기록, 순위 기록
- 관리자 기능 일부(공지사항 작성, 게시글 삭제 권한, QnA 답변, 퀴즈 등록)
- 메인 페이지 디자인 구성 및 CSS 연동 처리
- 전체 페이지 CSS 모듈화 및 UI 리팩토링 (폰트, 컬러, 버튼 통일 등)

<br>

### 💫⭐담당 역할 중 Spring Boot에서 확장된 기능

최신 버전 [보러가기](https://github.com/jisu-chang/springboot-project)
